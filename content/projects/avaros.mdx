...
featuredImages:
      - "/assets/projects/avaros/dashboard-dark.png"
      - "/assets/projects/avaros/kpi-dashboard.png"
      - "/assets/projects/avaros/voice-chat.png"
      - "/assets/projects/avaros/settings-light.png"
demoUrl: ""
...
<ImageGallery images={[
  { src: "/assets/projects/avaros/dashboard-dark.png", alt: "AVAROS dashboard — KPI summary, system health, adapter/platform state, and integrated voice assistant panel" },
      { src: "/assets/projects/avaros/kpi-dashboard.png", alt: "AVAROS KPI dashboard — pilot tracking view with target progress, energy-per-unit and material efficiency trends" },
      { src: "/assets/projects/avaros/voice-chat.png", alt: "AVAROS voice assistant chat — conversational KPI query and answer flow in the embedded assistant panel" },
